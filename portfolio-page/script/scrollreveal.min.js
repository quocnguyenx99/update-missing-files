...
sr.reveal(`.hero__image`, { delay: 500 });
sr.reveal(`.hero-foot`, { delay: 600 });
sr.reveal(`.about__content`, { origin: "left" });
sr.reveal(`.skill__box`, { origin: "right" });
sr.reveal(`.project__item,  .footer__content, .footer__list, .footer__end`, {
  interval: 100,
});
